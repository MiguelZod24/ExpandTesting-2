...
class LoginPage:
    def __init__(self, page):
        self.page = page
        # Selectores ajustados siguiendo las mejores prácticas
        self.username_input = "input#username"  # Se recomienda usar selectores por ID si están disponibles.
        self.password_input = "input#password"
        self.login_button = "button[type='submit']"
        self.error_message = "#flash"

    def navegar(self):
        # Usa BASE_URL adecuadamente
    ...
    def obtener_error(self):
        # Web-first assertion con auto-retry
