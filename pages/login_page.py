...
class LoginPage:
    def __init__(self, page):
        self.page = page
        # Mejora los selectores utilizando get_by_role para mayor robustez
        self.username_input = "[role='textbox'][name='username']"  # Ajuste para getByRole
        self.password_input = "[role='textbox'][name='password']"  # Ajuste para getByRole
        self.login_button = "[role='button'][type='submit']"
