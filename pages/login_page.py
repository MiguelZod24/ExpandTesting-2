...
class LoginPage:
    def __init__(self, page):
        self.page = page
        # Selectores adecuados según la regla TestDino: getByRole() preferido sobre CSS/XPath
    ...
    def navegar(self):
        # Uso del BASE_URL en la configuración para cumplir con TestDino: Golden Rule #5
    ...
    def obtener_error(self):
        # TestDino: Web-first assertions con auto-retry
    ...
    def campo_vacio(self, campo):
        ...
        # TestDino: Web-first assertion con auto-retry
