...
class LoginPage:
    def __init__(self, page):
        ...
        self.username_input = "input[id='username']"  # Selector mejorado para mayor precisión
        self.password_input = "input[id='password']"  # Selector mejorado para mayor precisión
    ...
    def obtener_error(self):
        ...
        return self.page.inner_text(self.error_message).strip()
